...
| **R-7** | **NFR-03** — cost | "Free tiers only." | Adds the measured budget: **200,000 tokens/day ≈ 187 tickets at the measured 652 tokens/call and 1.64 calls/ticket, across all runs.** | Discovered by exhausting it. The cap appears only in the 429 body; every rate-limit header describes the per-minute bucket, which was full. | 2026-09-08 |
